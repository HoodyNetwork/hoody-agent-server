...
export const EmptyWithNotificationsAndHistory: Story = {
	...
	decorators: [
		(Story) => {
			// Mock notifications for HoodycodeNotifications component
			React.useEffect(() => {
				const mockNotifications = [
					{
						...
						action: {
							...
							actionURL: "https://hoodycode.com/features/code-analysis",
						},
					},
					{
						id: "notification-2",
				...
				// Simulate the message event that HoodycodeNotifications listens for
	...
	parameters: {
		extensionState: {
			...
			apiConfiguration: {
				apiProvider: "hoodycode", // Set to hoodycode to show notifications
				apiModelId: "claude-3-5-sonnet-20241022",
				apiKey: "mock-key",
			},
			mcpServers: [],
