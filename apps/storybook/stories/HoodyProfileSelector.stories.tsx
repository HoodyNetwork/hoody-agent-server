...
import { HoodyProfileSelector } from "../../../webview-ui/src/components/hoodycode/chat/HoodyProfileSelector"
...
interface HoodyProfileSelectorStoryProps {
	initiallyOpen?: boolean
}

const HoodyProfileSelectorStory = ({ initiallyOpen }: HoodyProfileSelectorStoryProps) => {
...
const meta: Meta<typeof HoodyProfileSelectorStory> = {
	title: "Chat/HoodyProfileSelector",
	component: HoodyProfileSelectorStory,
