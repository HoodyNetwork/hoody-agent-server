...
describe("GhostServiceSettingsView", () => {
	...
	it("renders basic trigger settings", () => {
		...
		expect(screen.getByText(/hoodycode:ghost.settings.triggers/)).toBeInTheDocument()
		expect(screen.getByText(/hoodycode:ghost.settings.enableAutoTrigger.label/)).toBeInTheDocument()
	})
	...
	it("toggles auto trigger checkbox correctly", () => {
		...
		const checkbox = screen
			.getByText(/hoodycode:ghost.settings.enableAutoTrigger.label/)
			.closest("label")
	...
	it("toggles quick inline task keybinding checkbox correctly", () => {
		...
		const checkbox = screen
			.getByText(/hoodycode:ghost.settings.enableQuickInlineTaskKeybinding.label/)
			.closest("label")
			?.querySelector("input[type='checkbox']")
	...
	it("toggles smart inline task keybinding checkbox correctly", () => {
		...
		const checkbox = screen
			.getByText(/hoodycode:ghost.settings.enableSmartInlineTaskKeybinding.label/)
			.closest("label")
			?.querySelector("input[type='checkbox']")
	...
	it("shows auto-trigger delay slider when auto-trigger is enabled", () => {
		...
		expect(screen.getByText(/hoodycode:ghost.settings.autoTriggerDelay.label/)).toBeInTheDocument()
	...
	it("hides auto-trigger delay slider when auto-trigger is disabled", () => {
		...
		expect(screen.queryByText(/hoodycode:ghost.settings.autoTriggerDelay.label/)).not.toBeInTheDocument()
