...
const RulesWorkflowsSection: React.FC<RulesWorkflowsSectionProps> = ({
	...
	const globalSectionKey =
		type === "rule" ? "hoodycode:rules.sections.globalRules" : "hoodycode:rules.sections.globalWorkflows"
	const workspaceSectionKey =
		type === "rule" ? "hoodycode:rules.sections.workspaceRules" : "hoodycode:rules.sections.workspaceWorkflows"
