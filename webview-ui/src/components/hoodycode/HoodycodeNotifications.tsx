...
export const HoodycodeNotifications: React.FC = () => {
	...
	useEffect(() => {
		const handleMessage = (event: MessageEvent) => {
			...
			if (message.type === "hoodycodeNotificationsResponse") {
	...
	useEffect(() => {
		vscode.postMessage({ type: "fetchHoodycodeNotifications" })
	}, [])
	...
	return (
		<div className="hoodycode-notifications flex flex-col mb-4">
