...
interface HoodyChatRowUserFeedbackProps {
	message: ClineMessage
	isStreaming: boolean
	onChatReset?: () => void
}

export const HoodyChatRowUserFeedback = ({ message, isStreaming, onChatReset }: HoodyChatRowUserFeedbackProps) => {
