...
import type { DropdownOption } from "@/components/ui/select-dropdown" // hoodycode_change
import { useAppTranslation } from "@/i18n/TranslationContext"
import { vscode } from "@/utils/vscode"
import { cn } from "@/lib/utils"

interface HoodyModeSelectorProps {
	value: Mode
...
export const HoodyModeSelector = ({
	value,
	onChange,
	modeShortcutText,
	customModes,
...
export default HoodyModeSelector
