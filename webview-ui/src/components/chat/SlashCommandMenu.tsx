...
const SlashCommandMenu: React.FC<SlashCommandMenuProps> = ({
	...
	const { localWorkflows, globalWorkflows } = useExtensionState() // hoodycode_change
	...
	const filteredCommands = getMatchingSlashCommands(query, customModes, localWorkflows, globalWorkflows) // hoodycode_change
