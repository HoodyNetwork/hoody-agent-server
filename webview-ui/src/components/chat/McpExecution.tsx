...
interface McpExecutionProps {
	...
	initiallyExpanded?: boolean // hoodycode_change: For Storybook stories only
}
...
export const McpExecution = ({
	...
	initiallyExpanded = false, // hoodycode_change
}: McpExecutionProps) => {
	...
	// hoodycode_change: Main collapse state for the entire MCP execution content
	...
	// hoodycode_change: Only parse response data when main content is expanded AND complete to avoid parsing partial JSON
	...
	return (
		<>
			<div
				...
				onClick={onToggleResponseExpand /* hoodycode_change */}>
				...
				<div className="flex flex-row items-center justify-between gap-2 px-1">
					...
					{/* hoodycode_change start - moved Chevron button */}
					<Button
						variant="ghost"
						size="icon"
						onClick={(e) => {
					...
					{/* hoodycode_change end - moved Chevron button */}
				</div>
			</div>
