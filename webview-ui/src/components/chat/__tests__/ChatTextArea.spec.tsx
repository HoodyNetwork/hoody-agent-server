...
import { useQuery } from "@tanstack/react-query" // hoodycode_change
import { HistoryItem } from "@roo-code/types" // hoodycode_change
...
function hoodyCodeSetUpUseQueryMock(historyItems: Partial<HistoryItem>[]) {
...
describe("ChatTextArea", () => {
	...
	describe("multi-file drag and drop", () => {
		...
		describe("prompt history navigation", () => {
			...
			it("should use task history (oldest first) when no conversation messages exist", () => {
				...
				hoodyCodeSetUpUseQueryMock(mockTaskHistory)
	...
	// hoodycode_change: skip because we have our own slash commands
	...
	// hoodycode_change: removed in hoodycode
