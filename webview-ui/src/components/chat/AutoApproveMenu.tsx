...
import { MaxRequestsInput } from "../settings/MaxRequestsInput" // hoodycode_change
import { MaxCostInput } from "../settings/MaxCostInput" // hoodycode_change
...
const AutoApproveMenu = ({ style }: AutoApproveMenuProps) => {
	...
	const {
		...
		allowedMaxRequests, // hoodycode_change
		allowedMaxCost, // hoodycode_change
		...
		setAllowedMaxRequests, // hoodycode_change
		setAllowedMaxCost, // hoodycode_change
	} = useExtensionState()
