...
const DiscordLink = () => (
	<VSCodeLink
		href="https://discord.social.hoody.com"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://discord.social.hoody.com" })
		}}>
		Discord
	</VSCodeLink>
)
...
const RedditLink = () => (
	<VSCodeLink
		href="https://reddit.social.hoody.com"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://reddit.social.hoody.com" })
		}}>
		r/RooCode
	</VSCodeLink>
)
...
// hoodycode_change: file unused, no need to touch anything
