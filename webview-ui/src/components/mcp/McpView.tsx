...
import {
	...
	DialogFooter,
	ToggleSwitch,
	// StandardTooltip, // hoodycode_change: not used
...
// import McpEnabledToggle from "./McpEnabledToggle" // hoodycode_change not used
import { McpErrorRow } from "./McpErrorRow"

type McpViewProps = {
	onDone: () => void
	hideHeader?: boolean // hoodycode_change
}
...
const McpView = ({ onDone, hideHeader = false }: McpViewProps) => {
	...
	return (
		// hoodycode_change: add relative className
		<Tab className="relative">
			{/*  hoodycode_change: display header conditionally */}
			...
			<TabContent>
				<div
					...
					<Trans i18nKey="mcp:description">
						<VSCodeLink
							href={buildDocLink("features/mcp/using-mcp-in-hoody-code", "mcp_settings")}
				...
				{/* <McpEnabledToggle /> hoodycode_change: we always enable MCP */}

				{mcpEnabled && (
					<>
						{/* hoodycode_change: display: none; we always allow mcp server creation */}
						<div style={{ display: "none", marginBottom: 15 }}>
							...
							<div
								...
								<Trans i18nKey="mcp:enableServerCreation.description">
									<VSCodeLink
										href={buildDocLink(
											"features/mcp/using-mcp-in-hoody-code#how-to-use-hoody-code-to-create-an-mcp-server",
											"mcp_server_creation",
										)}
										style={{ display: "inline" }}>
						...
						<div
							...
							<VSCodeLink
								href={buildDocLink(
									"features/mcp/using-mcp-in-hoody-code#editing-mcp-settings-files",
									"mcp_edit_settings",
								)}
								style={{ display: "inline" }}>
