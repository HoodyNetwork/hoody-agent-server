...
import { ExtensionStateContextProvider } from "@src/context/ExtensionStateContext" // hoodycode_change
...
const createWrapper = () => {
	...
	// hoodycode_change start: wrap with ExtensionStateContextProvider
