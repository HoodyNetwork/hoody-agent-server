...
import { getTaskHistory } from "@roo/hoodycode/getTaskHistory"
import { TaskHistoryRequestPayload } from "@roo/WebviewMessage"

vi.mock("@/hoodycode/hooks/useTaskHistory")

function hoodyCodeSetUpUseTaskHistoryMock(taskHistory: Partial<HistoryItem>[], cwd: string) {
...
describe("useTaskSearch", () => {
	beforeEach(() => {
		...
		hoodyCodeSetUpUseTaskHistoryMock(mockTaskHistory, "/workspace/project1")
	})
	...
	it("handles empty task history", () => {
		...
		hoodyCodeSetUpUseTaskHistoryMock([], "/workspace/project1")
