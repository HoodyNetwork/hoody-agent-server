...
const HistoryView = ({ onDone }: HistoryViewProps) => {
	...
	return (
		<Tab>
							...
							<div className="flex items-center gap-2">
								...
								<span className="ml-auto text-vscode-descriptionForeground text-xs">
									{t("history:selectedItems", {
										...
										total: taskHistoryFullLength, // hoodycode_change
									})}
								</span>
							</div>
						</div>
			...
			{/* hoodycode_change: more nesting so we can add more rows, removed fixed class */}
					...
					<div className="border-t border-b border-vscode-panel-border p-2 flex justify-between items-center">
						...
						<div className="flex gap-2">
							<Button
								...
								{t("hoodycode:pagination.previous")}
							</Button>
							<Button
