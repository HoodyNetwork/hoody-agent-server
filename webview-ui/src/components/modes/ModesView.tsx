...
import { OrganizationModeWarning } from "../hoodycode/OrganizationModeWarning"
	...
	return (
		<Tab>
			...
			<TabContent>
				...
				{/* Name section */}
				<div className="mb-5">
					{isOrganizationMode && <OrganizationModeWarning />} {/* hoodycode_change start */}
					...
					<div className="mb-4">
						<div className="flex justify-between items-center mb-1">
							...
							{/* hoodycode_change: Added !isOrganizationMode check */}
						...
						<VSCodeTextArea
							...
							// hoodycode_change disable editing for org modes
					...
					<div className="mb-4">
						<div className="flex justify-between items-center mb-1">
							...
							{/* hoodycode_change don't show for org modes */}
							{!findModeBySlug(visualMode, customModes) && !isOrganizationMode && (
									...
									span: (
										<span
											...
											onClick={() => {
												...
												vscode.postMessage({
													type: "openFile",
													text: `./.hoodycode/rules-${currentMode.slug}/rules.md`,
													values: {
														create: true,
														content: "",
													},
												...
												span: (
													<span
														...
														onClick={() => {
															...
															vscode.postMessage({
																type: "openFile",
																text: `./.hoodycode/system-prompt-${currentMode.slug}`, // hoodycode_change
																values: {
																	create: true,
																	content: "",
																},
