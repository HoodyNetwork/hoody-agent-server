import { useState, useCallback, useEffect, useRef, Fragment } from "react" // hoodycode_change Fragment
...
import { usePreferredModels } from "@/components/ui/hooks/hoodycode/usePreferredModels" // hoodycode_change
// import { filterModels } from "./utils/organizationFilters" // hoodycode_change: not doing this
...
import {
	...
	PopoverTrigger,
	Button,
	SelectSeparator, // hoodycode_change
} from "@src/components/ui"
import { useEscapeKey } from "@src/hooks/useEscapeKey"

import { ModelInfoView } from "./ModelInfoView"
import { ApiErrorMessage } from "./ApiErrorMessage"
import { HoodyModelInfoView } from "../hoodycode/settings/HoodyModelInfoView"
...
export const ModelPicker = ({
	...
	// organizationAllowList, // hoodycode_change: unused
	errorMessage,
}: ModelPickerProps) => {
	...
	return (
		<>
			...
			{errorMessage && <ApiErrorMessage errorMessage={errorMessage} />}
			{
				...
				selectedModelId &&
					selectedModelInfo &&
					(apiConfiguration.apiProvider === "hoodycode" || apiConfiguration.apiProvider === "openrouter" ? (
						<HoodyModelInfoView
			...
			<div className="text-sm text-vscode-descriptionForeground">
				{
					...
					apiConfiguration.apiProvider === "hoodycode" ? (
						<Trans i18nKey="hoodycode:settings.provider.automaticFetch" />
					) : (
						<Trans
