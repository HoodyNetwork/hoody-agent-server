			...
			<Section>
				<div>
					...
					<p className="text-vscode-descriptionForeground text-sm mt-0">
						<Trans
							...
							components={{
								privacyLink: <VSCodeLink href="https://hoody.com/privacy" />,
							}}
						/>
					</p>
				</div>
				...
				<div>
					<Trans
						...
						components={{
							githubLink: <VSCodeLink href="https://github.com/HoodyNetwork/hoody-agent-server" />,
							redditLink: <VSCodeLink href="https://reddit.social.hoody.com" />,
							discordLink: <VSCodeLink href="https://discord.social.hoody.com" />,
						}}
					/>
				</div>
				...
				<div>
					<Trans
						...
						components={{
							supportLink: <VSCodeLink href="https://hoody.com/support" />,
						}}
					/>
				</div>
