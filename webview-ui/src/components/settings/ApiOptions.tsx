import React, { Fragment, memo, useCallback, useEffect, useMemo, useState } from "react" // hoodycode_change Fragment
import { convertHeadersToObject } from "./utils/headers"
import { useDebounce } from "react-use"
import { VSCodeLink, VSCodeButton } from "@vscode/webview-ui-toolkit/react"
// import { ExternalLinkIcon } from "@radix-ui/react-icons" // hoodycode_change
...
import {
	...
	syntheticDefaultModelId, // hoodycode_change
	featherlessDefaultModelId,
	ioIntelligenceDefaultModelId,
	rooDefaultModelId,
	vercelAiGatewayDefaultModelId,
	deepInfraDefaultModelId,
	ovhCloudAiEndpointsDefaultModelId, // hoodycode_change
} from "@roo-code/types"
...
import {
	...
	VercelAiGateway,
	DeepInfra,
	OvhCloudAiEndpoints, // hoodycode_change
} from "./providers"

import { MODELS_BY_PROVIDER, PROVIDERS } from "./constants"
import { inputEventTransform, noTransform } from "./transforms"
// import { ModelPicker } from "./ModelPicker" // hoodycode_change
...
import { HoodyCode } from "../hoodycode/settings/providers/HoodyCode" // hoodycode_change
import { buildDocLink } from "@src/utils/docLinks"
import { HoodyProviderRouting, HoodyProviderRoutingManagedByOrganization } from "./providers/HoodyProviderRouting"
...
const ApiOptions = ({
	...
	// hoodycode_change start: queryKey, chutesApiKey
	const { data: routerModels, refetch: refetchRouterModels } = useRouterModels({
		openRouterBaseUrl: apiConfiguration?.openRouterBaseUrl,
		openRouterApiKey: apiConfiguration?.openRouterApiKey,
		hoodycodeOrganizationId: apiConfiguration?.hoodycodeOrganizationId ?? "personal",
	...
	useDebounce(
		() => {
			if (selectedProvider === "openai") {
				...
				selectedProvider === "chutes" // hoodycode_change
			) {
		...
		[
			...
			apiConfiguration?.chutesApiKey, // hoodycode_change
			apiConfiguration?.ovhCloudAiEndpointsBaseUrl, // hoodycode_change
			customHeaders,
		],
	)
	...
	const onProviderChange = useCallback(
		(value: ProviderName) => {
			...
			> = {
				...
				synthetic: { field: "apiModelId", default: syntheticDefaultModelId }, // hoodycode_change
				featherless: { field: "apiModelId", default: featherlessDefaultModelId },
				ovhcloud: { field: "ovhCloudAiEndpointsModelId", default: ovhCloudAiEndpointsDefaultModelId }, // hoodycode_change
				...
				// hoodycode_change start
				hoodycode: { field: "hoodycodeModel", default: hoodycodeDefaultModel },
		...
		[setApiConfigurationField, apiConfiguration, hoodycodeDefaultModel],
	)
	...
	// hoodycode_change start: no organizationAllowList
	...
	return (
		<div className="flex flex-col gap-3">
			...
			{/* hoodycode_change start */}
			{selectedProvider === "hoodycode" && (
				<HoodyCode
					apiConfiguration={apiConfiguration}
					setApiConfigurationField={setApiConfigurationField}
					routerModels={routerModels}
					organizationAllowList={organizationAllowList}
					hoodycodeDefaultModel={hoodycodeDefaultModel}
				/>
			)}
			{/* hoodycode_change end */}
			...
			{
				// hoodycode_change start
				(selectedProvider === "hoodycode" || selectedProvider === "openrouter") &&
					(apiConfiguration.hoodycodeOrganizationId ? (
						<HoodyProviderRoutingManagedByOrganization />
					) : (
						<HoodyProviderRouting
							apiConfiguration={apiConfiguration}
							setApiConfigurationField={setApiConfigurationField}
							hoodycodeDefaultModel={hoodycodeDefaultModel}
						/>
