...
vi.mock("@/components/ui", () => ({
	...
	SelectSeparator: () => <div data-testid="select-separator" />, // hoodycode_change
...
// hoodycode_change on next line, initial state initialization to work with localized checkboxes
