...
import {
	SetCachedStateField, // hoodycode_change
	SetExperimentEnabled,
} from "./types"
import { SectionHeader } from "./SectionHeader"
import { Section } from "./Section"
import { ExperimentalFeature } from "./ExperimentalFeature"
import { FastApplySettings } from "./FastApplySettings" // hoodycode_change: Use Fast Apply version
		...
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				{Object.entries(experimentConfigsMap)
					...
					.filter((config) => config[0] !== "MARKETPLACE") // hoodycode_change: we have our own market place, filter this out for now
					.map((config) => {
						...
						if (
							...
							return (
								<ImageGenerationSettings
									...
									currentProfileHoodycodeToken={currentProfileHoodycodeToken}
								/>
							)
						}
						return (
