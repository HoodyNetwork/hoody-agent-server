...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="https://github.com/HoodyNetwork/hoody-agent-server" style={{ display: "inline" }}>
				github.com/HoodyNetwork/hoody-agent-server
			</VSCodeLink>{" "}
			or join{" "}
			<VSCodeLink href="https://www.reddit.com/r/HoodyCode/" style={{ display: "inline" }}>
				reddit.com/r/HoodyCode
			</VSCodeLink>
			.
		</p>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			Regarding financial questions, please contact Customer Service at{" "}
			<VSCodeLink href="mail:hi@hoody.com" style={{ display: "inline" }}>
				hi@hoody.com
			</VSCodeLink>{" "}
		</p>
		<p className="italic">Hoody Code v{version}</p>
