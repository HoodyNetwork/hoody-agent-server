import { HTMLAttributes } from "react" // hoodycode_change
...
type NotificationSettingsProps = HTMLAttributes<HTMLDivElement> & {
	...
	areSettingsCommitted?: boolean // hoodycode_change
...
export const NotificationSettings = ({
	...
	areSettingsCommitted, // hoodycode_change
	setCachedStateField,
	...props
	...
	const onTestNotificationClick = () => {
		vscode.postMessage({
			...
			notificationOptions: {
				title: t("hoodycode:settings.systemNotifications.testTitle"),
				message: t("hoodycode:settings.systemNotifications.testMessage"),
			},
			alwaysAllow: true,
		})
	}
			...
			<Section>
				...
				<div>
					<VSCodeCheckbox
						...
						<span className="font-medium">{t("hoodycode:settings.systemNotifications.label")}</span>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1">
						{t("hoodycode:settings.systemNotifications.description")}
					</div>
				</div>
				{systemNotificationsEnabled && (
					<div className="flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background">
						<Button
							...
							{t("hoodycode:settings.systemNotifications.testButton")}
						</Button>
					</div>
				)}
				{/* hoodycode_change end */}
