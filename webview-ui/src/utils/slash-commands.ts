...
// hoodycode_change: this file was pulled from Cline and adjusted for us

import { getAllModes } from "@roo/modes"
import { getBasename } from "./hoodycode/path-webview"
...
export function getSupportedSlashCommands(
	...
	const baseCommands: SlashCommand[] = [
		...
		{
			name: "newrule",
			description: "Create a new Hoody rule with context from your conversation",
		},
		{ name: "reportbug", description: "Create a HoodyCode GitHub issue" },
