...
import {
	...
	openRouterDefaultModelId, // hoodycode_change
	type TodoItem,
...
import { McpMarketplaceCatalog } from "../../../src/shared/hoodycode/mcp" // hoodycode_change

import { vscode } from "@src/utils/vscode"
import { convertTextMateToHljs } from "@src/utils/textMateToHljs"
import { ClineRulesToggles } from "@roo/cline-rules" // hoodycode_change

export interface ExtensionStateContextType extends ExtensionState {
	historyPreviewCollapsed?: boolean
	showTaskTimeline?: boolean // hoodycode_change
	setShowTaskTimeline: (value: boolean) => void // hoodycode_change
	showTimestamps?: boolean // hoodycode_change
	setShowTimestamps: (value: boolean) => void // hoodycode_change
	hideCostBelowThreshold?: number // hoodycode_change
	setHideCostBelowThreshold: (value: number) => void // hoodycode_change
	hoveringTaskTimeline?: boolean // hoodycode_change
	setHoveringTaskTimeline: (value: boolean) => void // hoodycode_change
	systemNotificationsEnabled?: boolean // hoodycode_change
	setSystemNotificationsEnabled: (value: boolean) => void // hoodycode_change
	dismissedNotificationIds: string[] // hoodycode_change
	...
	allowVeryLargeReads?: boolean // hoodycode_change
	...
	setShowAutoApproveMenu: (value: boolean) => void // hoodycode_change
	...
	commitMessageApiConfigId?: string // hoodycode_change
	setCommitMessageApiConfigId: (value: string) => void // hoodycode_change
	markNotificationAsDismissed: (notificationId: string) => void // hoodycode_change
	ghostServiceSettings?: GhostServiceSettings // hoodycode_change
	setGhostServiceSettings: (value: GhostServiceSettings) => void // hoodycode_change
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		version: "",
		clineMessages: [],
		taskHistoryFullLength: 0, // hoodycode_change
		taskHistoryVersion: 0, // hoodycode_change
		...
		alwaysAllowWrite: true, // hoodycode_change
		alwaysAllowReadOnly: true, // hoodycode_change
		...
		showAutoApproveMenu: false, // hoodycode_change
		...
		allowVeryLargeReads: false, // hoodycode_change
		terminalZshP10k: false, // Default Powerlevel10k integration setting
		terminalZdotdir: false, // Default ZDOTDIR handling setting
		terminalCompressProgressBar: true, // Default to compress progress bar output
		historyPreviewCollapsed: false, // Initialize the new state (default to expanded)
		showTaskTimeline: true, // hoodycode_change
		showTimestamps: true, // hoodycode_change
		hoodycodeDefaultModel: openRouterDefaultModelId,
	...
	const [mcpMarketplaceCatalog, setMcpMarketplaceCatalog] = useState<McpMarketplaceCatalog>({ items: [] }) // hoodycode_change
	...
	const contextValue: ExtensionStateContextType = {
		...
		dismissedNotificationIds: state.dismissedNotificationIds || [], // hoodycode_change
		// hoodycode_change end
