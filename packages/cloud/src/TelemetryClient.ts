/* eslint-disable @typescript-eslint/no-unused-vars */ /* hoodycode_change this file is meant to be a stub */
import {
...
abstract class BaseTelemetryClient implements TelemetryClient {
	...
	public abstract updateIdentity(hoodycodeToken: string): Promise<void>
...
export class CloudTelemetryClient extends BaseTelemetryClient {
	...
	public override captureException(error: Error, properties?: Record<string | number, unknown>): void {} // hoodycode_change

	public override async updateIdentity(hoodycodeToken: string): Promise<void> {} // hoodycode_change
