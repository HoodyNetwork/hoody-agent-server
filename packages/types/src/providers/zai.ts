...
// Z AI
// https://docs.z.ai/guides/llm/glm-4.6 // hoodycode_change: overwrite the entire file on merge conflicts
// https://docs.z.ai/guides/overview/pricing

export type InternationalZAiModelId = keyof typeof internationalZAiModels
export const internationalZAiDefaultModelId: InternationalZAiModelId = "glm-4.6" // hoodycode_change: overwrite the entire file on merge conflicts
export const internationalZAiModels = {
	"glm-4.5": {
		...
		description: "Zhipu's previous flagship model.", // hoodycode_change: overwrite the entire file on merge conflicts
	},
	"glm-4.5-air": {
		maxTokens: 98_304,
		contextWindow: 131_072,
...
export const mainlandZAiDefaultModelId: MainlandZAiModelId = "glm-4.6" // hoodycode_change: overwrite the entire file on merge conflicts
