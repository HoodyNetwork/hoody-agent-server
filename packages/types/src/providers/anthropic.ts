...
export const anthropicDefaultModelId: AnthropicModelId = "claude-haiku-4-5"
...
export const anthropicModels = {
	...
	"claude-opus-4-1-20250805": {
		maxTokens: 32_000, // hoodycode_change: https://openrouter.ai/anthropic/claude-opus-4.1/providers
	...
	"claude-haiku-4-5": {
		maxTokens: 64_000, // Supports extended thinking like Sonnet 4.5
		contextWindow: 200_000,
		supportsImages: true,
		supportsComputerUse: true,
		supportsPromptCache: true,
		...
		cacheReadsPrice: 0.1,
		supportsReasoningBudget: true, // Extended thinking support
	},
