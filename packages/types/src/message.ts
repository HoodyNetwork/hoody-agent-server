import { z } from "zod"
import { hoodyCodeMetaDataSchema } from "./hoodycode.js"
...
export const clineMessageSchema = z.object({
	...
	/**
	 * Agent Digest - Ultra-compact LLM-generated summary for tiny UI contexts.
	 * This provides a compressed version of the message (50-200 chars) for:
	 * - Desktop notifications
	 * - Mobile compact views
	 * - Status bars
	 * - Task previews
	 *
	 * The AI agent always uses the full message content for context.
	 * The digest is purely for human-readable UI display.
	 */
	...
	digestMetadata: z
		.object({
			/** When the digest was generated (timestamp) */
			generatedAt: z.number(),
			/** AI profile ID used for digest generation */
			profileId: z.string(),
			/** Tokens used to generate the digest */
			tokensUsed: z.number().optional(),
			/** Maximum length requested for the digest */
			maxLength: z.number(),
		})
		.optional(),
	metadata: z
		.object({
			gpt5: z
				...
				.optional(),
			hoodyCode: hoodyCodeMetaDataSchema.optional(),
			// General message metadata for UI tracking
			general: z
				.object({
					/** AI model ID used for this message (e.g., "claude-sonnet-4.5") */
					modelId: z.string().optional(),
					/** AI provider (e.g., "anthropic", "openai") */
					provider: z.string().optional(),
					/** Profile name used (e.g., "My Claude Profile") */
					profileName: z.string().optional(),
					/** Profile ID used */
					profileId: z.string().optional(),
					/** Mode this message was created in (e.g., "code", "architect") */
					mode: z.string().optional(),
					/** Input tokens for this specific message/API call */
					tokensIn: z.number().optional(),
					/** Output tokens for this specific message/API call */
					tokensOut: z.number().optional(),
					/** Cache write tokens for this message */
					cacheWrites: z.number().optional(),
					/** Cache read tokens for this message */
					cacheReads: z.number().optional(),
					/** Cost for this specific message (USD) */
					cost: z.number().optional(),
					/** Cumulative total cost up to this message (USD) */
					cumulativeCost: z.number().optional(),
					/** Cumulative total tokens in up to this message */
					cumulativeTokensIn: z.number().optional(),
					/** Cumulative total tokens out up to this message */
					cumulativeTokensOut: z.number().optional(),
				})
				.optional(),
		})
		.optional(),
