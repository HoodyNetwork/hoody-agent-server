...
const baseProviderSettingsSchema = z.object({
	...
	// Task Auto-Init (per-profile).
	taskAutoInitEnabled: z.boolean().optional(),
	taskAutoInitSlashCommand: z.string().optional(),
	taskAutoInitMessage: z.string().optional(),
})
...
const hoodycodeSchema = baseProviderSettingsSchema.extend({
	hoodycodeToken: z.string().optional(),
	hoodycodeOrganizationId: z.string().optional(),
	hoodycodeModel: z.string().optional(),
	openRouterSpecificProvider: z.string().optional(),
	openRouterProviderDataCollection: openRouterProviderDataCollectionSchema.optional(),
	openRouterProviderSort: openRouterProviderSortSchema.optional(),
	openRouterZdr: z.boolean().optional(),
	hoodycodeTesterWarningsDisabledUntil: z.number().optional(), // Timestamp for disabling HOODYCODE-TESTER warnings
})
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	ovhcloudSchema.merge(z.object({ apiProvider: z.literal("ovhcloud") })), // hoodycode_change
	...
	hoodycodeSchema.merge(z.object({ apiProvider: z.literal("hoodycode") })),
...
export const providerSettingsSchema = z.object({
	...
	...ovhcloudSchema.shape, // hoodycode_change
})
...
export const modelIdKeysByProvider: Record<TypicalProvider, ModelIdKey> = {
	...
	"hoodycode-openrouter": "openRouterModelId",
	bedrock: "apiModelId",
	vertex: "apiModelId",
	...
	synthetic: "apiModelId", // hoodycode_change
	...
	ovhcloud: "ovhCloudAiEndpointsModelId", // hoodycode_change
}
...
> = {
	...
	ovhcloud: { id: "ovhcloud", label: "OVHcloud AI Endpoints", models: [] }, // hoodycode_change

	// hoodycode_change start
	hoodycode: { id: "hoodycode", label: "Hoodycode", models: [] },
	"hoodycode-openrouter": { id: "hoodycode-openrouter", label: "Hoodycode", models: [] }, // temporarily needed to satisfy because we're using 2 inconsistent names apparently
