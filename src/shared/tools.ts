...
export const TOOL_DISPLAY_NAMES: Record<ToolName, string> = {
	...
	edit_file: "edit file", // hoodycode_change: Morph fast apply
	...
	report_bug: "report bug", // hoodycode_change
	condense: "condense the current context window", // hoodycode_change
...
export const TOOL_GROUPS: Record<ToolGroup, ToolGroupConfig> = {
	...
	edit: {
		tools: [
			"apply_diff",
			"edit_file", // hoodycode_change: Morph fast apply
			"write_to_file",
			"insert_content",
			"search_and_replace",
			"new_rule", // hoodycode_change
			"generate_image",
		],
	},
	browser: {
