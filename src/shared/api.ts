...
export const getModelMaxOutputTokens = ({
	...
	/* hoodycode_change: don't limit Anthropic model output, no idea why this was done before
...
const dynamicProviderExtras = {
	...
	"hoodycode-openrouter": {} as { hoodycodeToken?: string; hoodycodeOrganizationId?: string }, // hoodycode_change
	...
	ollama: {} as { numCtx?: number }, // hoodycode_change
	lmstudio: {} as {}, // eslint-disable-line @typescript-eslint/no-empty-object-type
	ovhcloud: {} as { apiKey?: string }, // hoodycode_change
	chutes: {} as { apiKey?: string }, // hoodycode_change
