...
import { getCommitRangeForNewCompletion } from "../checkpoints/hoodycode/seeNewChanges"
			...
			if (command) {
				...
				if (lastMessage && lastMessage.ask === "command") {
					...
					await cline.say(
						...
						undefined,
						undefined,
						await getClineMessageOptions(cline), // hoodycode_change
					)
