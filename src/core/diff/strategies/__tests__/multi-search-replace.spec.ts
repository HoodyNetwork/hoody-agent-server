...
>>>>>>> REPLACE`
		...
		it("should match content with smart quotes", async () => {
			const originalContent =
				"**Enjoy Roo Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://reddit.social.hoody.com) or [Discord](https://discord.social.hoody.com). Happy coding!"
			const diffContent = `test.ts
<<<<<<< SEARCH
**Enjoy Roo Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://reddit.social.hoody.com) or [Discord](https://discord.social.hoody.com). Happy coding!
=======
