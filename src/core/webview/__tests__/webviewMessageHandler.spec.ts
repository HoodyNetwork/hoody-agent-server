...
describe("webviewMessageHandler - requestRouterModels", () => {
	...
	it("successfully fetches models from all providers", async () => {
		...
		expect(mockGetModels).toHaveBeenCalledWith({ provider: "openrouter", apiKey: "openrouter-key" }) // hoodycode_change: apiKey
		expect(mockGetModels).toHaveBeenCalledWith({ provider: "requesty", apiKey: "requesty-key" })
		expect(mockGetModels).toHaveBeenCalledWith({ provider: "glama" })
		expect(mockGetModels).toHaveBeenCalledWith({ provider: "unbound", apiKey: "unbound-key" })
		expect(mockGetModels).toHaveBeenCalledWith({ provider: "chutes", apiKey: "chutes-key" }) // hoodycode_change
	...
	it("handles individual provider failures gracefully", async () => {
		...
		mockGetModels
			...
			.mockRejectedValueOnce(new Error("Chutes API error")) // chutes // hoodycode_change
			.mockResolvedValueOnce(mockModels) // hoodycode-openrouter
	...
	it("handles Error objects and string errors correctly", async () => {
		...
		mockGetModels
			...
			.mockRejectedValueOnce(new Error("Unbound API error")) // unbound
			.mockRejectedValueOnce(new Error("Chutes API error")) // chutes // hoodycode_change
			.mockResolvedValueOnce({}) // hoodycode-openrouter - Success
			...
			.mockRejectedValueOnce(new Error("OVHcloud AI Endpoints error")) // ovhcloud // hoodycode_change
			.mockRejectedValueOnce(new Error("LiteLLM connection failed")) // litellm
