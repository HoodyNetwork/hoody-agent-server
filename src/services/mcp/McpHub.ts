...
import { NotificationService } from "./hoodycode/NotificationService"
...
export class McpHub {
	...
	readonly hoodyNotificationService = new NotificationService()
	...
	private async watchProjectMcpFile(): Promise<void> {
		...
		const projectMcpPattern = new vscode.RelativePattern(workspaceFolder, ".hoodycode/mcp.json")
  ...
  "mcpServers": {
	...
	private async getProjectMcpPath(): Promise<string | null> {
		...
		const projectMcpDir = path.join(workspacePath, ".hoodycode")
		...
		try {
			...
			// If not found in .hoodycode/, fall back to .mcp.json in root directory
	...
	private async connectToServer(
		...
		try {
			...
			this.hoodyNotificationService.connect(name, connection.client)
