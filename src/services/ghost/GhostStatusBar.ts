...
export class GhostStatusBar {
	...
	private init() {
		this.statusBar.text = t("hoodycode:ghost.statusBar.enabled")
		this.statusBar.tooltip = t("hoodycode:ghost.statusBar.tooltip.basic")
		this.statusBar.show()
	}
	...
	private humanFormatCost(cost: number): string {
		if (cost === 0) return t("hoodycode:ghost.statusBar.cost.zero")
		if (cost > 0 && cost < 0.01) return t("hoodycode:ghost.statusBar.cost.lessThanCent") // Less than one cent
	...
	// 	this.statusBar.text = t("hoodycode:ghost.statusBar.disabled")
	// 	this.statusBar.tooltip = t("hoodycode:ghost.statusBar.tooltip.disabled")
	// }

	private renderTokenError() {
		this.statusBar.text = t("hoodycode:ghost.statusBar.warning")
		this.statusBar.tooltip = t("hoodycode:ghost.statusBar.tooltip.tokenError")
	}
	...
	private renderDefault() {
		...
		this.statusBar.text = `${t("hoodycode:ghost.statusBar.enabled")} (${totalCostFormatted})`
		this.statusBar.tooltip = `\
${t("hoodycode:ghost.statusBar.tooltip.basic")}
• ${t("hoodycode:ghost.statusBar.tooltip.lastCompletion")} $${lastCompletionCostFormatted}
• ${t("hoodycode:ghost.statusBar.tooltip.sessionTotal")} ${totalCostFormatted}
• ${t("hoodycode:ghost.statusBar.tooltip.model")} ${this.model}\
`
	}
