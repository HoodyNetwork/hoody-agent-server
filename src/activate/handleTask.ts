...
export const handleNewTask = async (
	// hoodycode_change start: Add profile and mode switching support
	...
	// hoodycode_change start: Handle profile and mode switching if provided
	...
	// hoodycode_change end: Add profile and mode switching support
