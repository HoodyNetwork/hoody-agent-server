...
const USAGE_STORAGE_KEY = "hoodycode.virtualQuotaFallbackProvider.usage.v1"
const COOLDOWNS_STORAGE_KEY = "hoodycode.virtualQuotaFallbackProvider.cooldowns.v1"
