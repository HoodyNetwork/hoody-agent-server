...
vi.mock("../../i18n", () => ({
	t: vi.fn((key: string, params?: any) => {
		const translations: Record<string, string> = {
			"hoodycode:terminalCommandGenerator.inputPrompt": "Hoody: Describe the command you want to generate",
			"hoodycode:terminalCommandGenerator.inputPlaceholder":
				"e.g., kill the process running on port 3001, find large files, etc",
			"hoodycode:terminalCommandGenerator.noActiveTerminal":
				"No active terminal found. Please open a terminal first.",
			"hoodycode:terminalCommandGenerator.generatingProgress": "Generating terminal command...",
			"hoodycode:terminalCommandGenerator.commandGenerated": `Generated command: ${params?.command || ""}`,
			"hoodycode:terminalCommandGenerator.generationFailed": `Failed to generate command: ${params?.error || ""}`,
			"hoodycode:terminalCommandGenerator.warningDialog.title": "Always Verify AI-Generated Commands",
			"hoodycode:terminalCommandGenerator.warningDialog.message":
			...
			"hoodycode:terminalCommandGenerator.warningDialog.okButton": "OK, I Understand",
			"hoodycode:terminalCommandGenerator.warningDialog.cancelButton": "Cancel",
		}
...
describe("generateTerminalCommand", () => {
	...
	it("should generate and place terminal command without executing", async () => {
		...
		expect(vscode.window.showInputBox).toHaveBeenCalledWith({
			prompt: "Hoody: Describe the command you want to generate",
