...
import {
	...
	ZAiHandler,
	FireworksHandler,
	SyntheticHandler, // hoodycode_change
	RooHandler,
	FeatherlessHandler,
	VercelAiGatewayHandler,
	DeepInfraHandler,
	OVHcloudAIEndpointsHandler, // hoodycode_change
} from "./providers"
// hoodycode_change start
import { HoodycodeOpenrouterHandler } from "./providers/hoodycode-openrouter"
// hoodycode_change end
...
export function buildApiHandler(configuration: ProviderSettings): ApiHandler {
	...
	switch (apiProvider) {
		// hoodycode_change start
		case "hoodycode":
			return new HoodycodeOpenrouterHandler(options)
		case "hoodycode-openrouter": // temp typing fix
			return new HoodycodeOpenrouterHandler(options)
		case "gemini-cli":
