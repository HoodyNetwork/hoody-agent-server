...
This directory contains the JetBrains plugin implementation for Hoody Code, including both the IntelliJ plugin (Kotlin) and the Extension Host (Node.js/TypeScript).
...
pnpm --filter @hoody-code/jetbrains-host build
```
...
- `vscodePlugin`: Plugin name (default: hoodycode)
