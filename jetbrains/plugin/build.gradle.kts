...
ext {
    ...
    set("vscodePlugin", project.findProperty("vscodePlugin") ?: "hoodycode")
}
...
tasks {
    ...
    register("generateConfigProperties") {
        ...
        doLast {
            val configDir = File("$projectDir/src/main/resources/ai/hoodycode/jetbrains/plugin/config")
            configDir.mkdirs()
    ...
    register("convertTranslations") {
        ...
        doLast {
            ...
            // Find all JSON bundles (jetbrains.json, hoodycode.json, etc.)
