...
package ai.hoodycode.jetbrains.actors

import com.intellij.openapi.Disposable
import com.intellij.openapi.diagnostic.Logger
import com.intellij.openapi.project.Project
import com.intellij.openapi.project.ProjectManager
import ai.hoodycode.jetbrains.events.EventBus
import ai.hoodycode.jetbrains.events.ProjectEventBus
import ai.hoodycode.jetbrains.events.WebviewHtmlUpdateData
import ai.hoodycode.jetbrains.events.WebviewHtmlUpdateEvent
...
class MainThreadWebviews(val project: Project) : MainThreadWebviewsShape {
    ...
    override fun setHtml(handle: WebviewHandle, value: String) {
        ...
        try {
            // Replace vscode-file protocol format, using regex to match from vscode-file:/ to /hoodycode/ part
            val modifiedHtml = value.replace(Regex("vscode-file:/.*?/hoodycode/"), "/")
