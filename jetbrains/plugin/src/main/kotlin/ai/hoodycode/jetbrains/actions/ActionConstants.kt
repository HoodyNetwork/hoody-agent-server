...
object CommandIds {
    ...
    const val EXPLAIN = "hoody-code.explainCode"
    /** Command ID for fixing code */
    const val FIX = "hoody-code.fixCode"
    /** Command ID for improving code */
    const val IMPROVE = "hoody-code.improveCode"
    /** Command ID for adding to context */
    const val ADD_TO_CONTEXT = "hoody-code.addToContext"
    /** Command ID for creating a new task */
    const val NEW_TASK = "hoody-code.newTask"
}
