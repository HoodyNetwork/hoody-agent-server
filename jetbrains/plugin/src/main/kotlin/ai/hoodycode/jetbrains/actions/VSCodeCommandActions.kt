...
package ai.hoodycode.jetbrains.actions
...
class PlusButtonClickAction : AnAction() {
    ...
    private val commandId: String = "hoody-code.plusButtonClicked"
...
class PromptsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "hoody-code.promptsButtonClicked"
...
class MCPButtonClickAction : AnAction() {
    ...
    private val commandId: String = "hoody-code.mcpButtonClicked"
...
class HistoryButtonClickAction : AnAction() {
    ...
    private val commandId: String = "hoody-code.historyButtonClicked"
...
class ProfileButtonClickAction : AnAction() {
    ...
    private val commandId: String = "hoody-code.profileButtonClicked"
    /**
...
class SettingsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "hoody-code.settingsButtonClicked"
...
class MarketplaceButtonClickAction : AnAction() {
    ...
    private val commandId: String = "hoody-code.marketplaceButtonClicked"
 ...
 */
class OpenDevToolsAction(private val getWebViewInstance: () -> ai.hoodycode.jetbrains.webview.WebViewInstance?) : AnAction("Open Developer Tools") {
