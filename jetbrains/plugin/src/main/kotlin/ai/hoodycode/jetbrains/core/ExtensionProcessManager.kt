...
import ai.hoodycode.jetbrains.util.ProxyConfigUtil
import java.io.File
import java.util.concurrent.TimeUnit
import ai.hoodycode.jetbrains.util.ExtensionUtils
import ai.hoodycode.jetbrains.util.PluginConstants
import ai.hoodycode.jetbrains.util.NotificationUtil
import ai.hoodycode.jetbrains.util.NodeVersionUtil
import ai.hoodycode.jetbrains.util.NodeVersion
import ai.hoodycode.jetbrains.i18n.I18n
...
//                "--trace-uncaught",
    ...
    fun findExtensionEntryFile(): String? {
        ...
        // Normal mode
        val resourcesPath = ai.hoodycode.jetbrains.util.PluginResourceUtil.getResourcePath(PLUGIN_ID, "$RUNTIME_DIR/$EXTENSION_ENTRY_FILE")
        if (resourcesPath != null) {
