...
import ai.hoodycode.jetbrains.editor.EditorAndDocManager
import ai.hoodycode.jetbrains.ipc.NodeSocket
import ai.hoodycode.jetbrains.ipc.PersistentProtocol
import ai.hoodycode.jetbrains.ipc.proxy.ResponsiveState
import ai.hoodycode.jetbrains.util.PluginConstants
import ai.hoodycode.jetbrains.util.PluginResourceUtil
import ai.hoodycode.jetbrains.util.URI
    ...
    private fun createInitData(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "environment" to mapOf(
                ...
                "globalStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".hoodycode", "globalStorage").toString()),
                "workspaceStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".hoodycode", "workspaceStorage").toString()),
