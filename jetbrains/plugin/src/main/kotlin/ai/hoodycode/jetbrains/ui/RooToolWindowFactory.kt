...
package ai.hoodycode.jetbrains.ui
...
import ai.hoodycode.jetbrains.actions.OpenDevToolsAction
import ai.hoodycode.jetbrains.plugin.WecoderPlugin
import ai.hoodycode.jetbrains.plugin.WecoderPluginService
import ai.hoodycode.jetbrains.plugin.DEBUG_MODE
import ai.hoodycode.jetbrains.webview.DragDropHandler
import ai.hoodycode.jetbrains.webview.WebViewCreationCallback
import ai.hoodycode.jetbrains.webview.WebViewInstance
    ...
    private class RooToolWindowContent(
        ...
        private fun createSystemInfoText(): String {
            ...
            return buildString {
                ...
                append("<p>Hoody Code is initializing...")
                ...
                if (!jcefSupported) {
                    ...
                    append("<a href='https://hoody.com/docs/jetbrains-troubleshooting' target='_blank' style='color: #721c24; text-decoration: underline;'>See JetBrains docs for how to enable JCEF in your IDE</a>")
                    append("</div>")
                    append("<br>")
                }
        ...
        private val knownIssuesButton = JButton("Known Issues").apply {
            ...
            addActionListener {
                ...
                BrowserUtil.browse("https://hoody.com/docs")
            }
        }
