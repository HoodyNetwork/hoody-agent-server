...
export class TelemetryClient {
	...
	public async updateHoodycodeUserId(hoodycodeToken: string): Promise<void> {
		...
		await identityManager.updateHoodycodeUserId(hoodycodeToken)
	...
	public clearHoodycodeUserId(): void {
		const identityManager = getIdentityManager()
		identityManager.clearHoodycodeUserId()
		this.identity = identityManager.getIdentity()
	}
	...
	private getBaseProperties(): BaseProperties {
		...
		// Only include hoodycodeUserId if it exists
		if (this.identity.hoodycodeUserId) {
			baseProps.hoodycodeUserId = this.identity.hoodycodeUserId
		}
